  ...
  <a-row class="header" type="flex" justify="space-between">
    <a-col>
      <a-space>
        ...
        <span v-if="!actived" class="file-name" onClick="inputActive"
          >{{ fileName }}{{ ext }}</span
        >
        <a-input
          size="small"
          ...
          v-model="fileName"
          @blur="inputDeActive"
          @pressEnter="inputDeActive"
        ></a-input>
      </a-space>
    </a-col>
    <a-col>
      <a-space>
        <a-button size="small" onClick="fullScreen">全屏</a-button>
        <a-upload
          :file-list="fileList"
          :remove="handleRemove"
          :showUploadList="false"
          :before-upload="beforeUpload"
        >
          <a-button size="small" onClick="importCode">导入</a-button>
        </a-upload>
        <a-button size="small" onClick="exportCode">导出</a-button>
        <a-button size="small" onClick="copy">复制</a-button>
        <a-button size="small" onClick="empty">清空</a-button>
      </a-space>
    </a-col>
  </a-row>
</template> -->
